...
int main() {
    ...
    //Creating a sprite for ammo icon
    Sprite spriteAmmoIcon = Sprite(TextureHolder::GetTexture
    ...
    highScoreStream << "High Score: " << hiScore;
    hiScoreText.setString(highScoreStream.str());
    ...
    while (window.isOpen()) {
        ...
        */
        ...
        while (window.pollEvent(event)) {
            if (event.KeyPressed == Event::KeyPressed) {
